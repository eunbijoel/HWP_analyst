"""
Editing-only preview layer — pending/applied highlights, canvas select chrome.

Plain read-only preview: hwp_core.shared.preview.plain
"""
...
from hwp_core.shared.preview.plain import PREVIEW_CSS as _PLAIN_CSS
from hwp_core.shared.preview.plain import build_preview_from_text  # re-export for editor callers

# Extend shared CSS with edit/selection chrome
PREVIEW_CSS = _PLAIN_CSS + """
<style>
/* 대기 중 (AI 제안) */
